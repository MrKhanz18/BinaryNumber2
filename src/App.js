...
function App() {
    return (
        <div className="App bg-dark">   
         ...
         <div className="sidebar-sticky">
          ...
          <div className="row col-md-9 ml-auto">
          <div id="c1"class="col-md-3 col-sm-4 col-lg-3">
          <div className="card float-right d-block w-100">
            <img src={require("./Movies/Iron Man/e5751316c3b567b2e17c914c5c51c85d.jpg")} className="card-img-top" alt="..."/>
            <div className="card-body bg-dark text-center">
                <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#ironman1">Iron Man</button>  
    ...
    <div id="c2"className="col-md-3 col-sm-4 col-lg-3">
          <div className="card float-right d-block w-100">
            <img src={require("./Movies/The Incredible Hulk/1206861-incredible_hulk_un_official_poster_4.jpg")} className="card-img-top" alt="..."/>
            <div className="card-body bg-dark text-center">
                <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#tih">The Incredible Hulk</button>  
    ...
    <div id="c3"className="col-md-3 col-sm-4 col-lg-3">
          <div className="card float-right d-block w-100">
            <img src={require("./Movies/Iron Man 2/movieposter.jpg")} className="card-img-top" alt="..."/>
            <div className="card-body bg-dark text-center">
                <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#im2">Iron Man 2</button>  
    ...
    <div id="c4" className="col-md-3 col-sm-4 col-lg-3">
        <div className="card float-right d-block w-100">
          ...
          <div className="card-body bg-dark text-center">
            <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#thor">Thor</button>  
  ...
  <div id="c5"className="col-md-3 col-sm-4 col-lg-3">
    <div className="card float-right d-block w-100">
      <img src={require("./Movies/Captain America - The First Avenger/7d4ecc8bc5ccf7fa94765222011b17cf.jpg")} className="card-img-top" alt="..."/>
      <div className="card-body bg-dark text-center">
        <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#ca1">Captain America: The First Avenger</button>  
...
<div id="c6" className="col-md-3 col-sm-4 col-lg-3">
<div className="card float-right d-block w-100">
  <img src={require("./Movies/The Avengers/b2090d1ae0c016943371b6c01dddcf08.jpg")} className="card-img-top" alt="..."/>
  <div className="card-body bg-dark text-center">
    <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#A1">The Avengers</button>  
...
<div className="row col-9 ml-auto">
  <div id="c1"className="col-md-3">
        <div className="card float-right d-block w-100">
          ...
          <div className="card-body bg-dark text-center">
              <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#im3">Iron Man 3</button>  
  ...
  <div id="c2"className="col-md-3">
        <div className="card float-right d-block w-100">
          ...
          <div className="card-body bg-dark text-center">
              <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#thor2">Thor: The Dark World</button>  
  ...
  <div id="c3"className="col-md-3">
        <div className="card float-right d-block w-100">
          ...
          <div className="card-body bg-dark text-center">
              <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#ca2">Captain America: The Winter Soldier</button>  
  ...
  <div id="c4" className="col-md-3">
      <div className="card float-right d-block w-100">
        ...
        <div className="card-body bg-dark text-center">
          <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#gog">Guardians Of The Galaxy</button>  
...
<div id="c5"className="col-md-3">
  <div className="card float-right d-block w-100">
    ...
    <div className="card-body bg-dark text-center">
      <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#A2">Avengers: Age Of Ultron</button>  
...
<div className="card-body bg-dark text-center">
  <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#ant">Ant-Man</button>  
...
<div className="row col-9 ml-auto">
    <div id="c1"className="col-md-3">
          <div className="card float-right d-block w-100">
            ...
            <div className="card-body bg-dark text-center">
                <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#ca3">Captain America: Civil War</button>  
    ...
    <div id="c2"className="col-md-3">
          <div className="card float-right d-block w-100">
            ...
            <div className="card-body bg-dark text-center">
                <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#ds">Doctor Strange</button>  
    ...
    <div id="c3"className="col-md-3">
          <div className="card float-right d-block w-100">
            ...
            <div className="card-body bg-dark text-center">
                <button class="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#got2">Guardians Of The Galaxy Vol.2</button>  
    ...
    <div id="c4" className="col-md-3">
        <div className="card float-right d-block w-100">
          ...
          <div className="card-body bg-dark text-center">
            <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#sm">Spider-Man Homecoming</button>  
  ...
  <div id="c5"className="col-md-3">
    <div className="card float-right d-block w-100">
      ...
      <div className="card-body bg-dark text-center">
        <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#thor3">Thor: Ragnarok</button>  
  ...
  <div class="card-body bg-dark text-center">
    <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#bp">Black Panther</button>  
  ...
  <div id="c7" className="col-md-3">
    ...
    <div className="card-body bg-dark text-center">
        <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#A3">Avengers: Infinity War</button>  
  ...
  <div id="c8" className="col-md-3">
    ...
    <div className="card-body bg-dark text-center">
        <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#ant2">Ant-Man And The Wasp</button>  
  ...
  <div id="c9" className="col-md-3">
    ...
    <div className="card-body bg-dark text-center">
        <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#cm">Captain Marvel</button>  
  ...
  <div id="c10" className="col-md-3">
    ...
    <div className="card-body bg-dark text-center">
        <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#A4">Avengers: Endgame</button>  
  ...
  <div id="c11" className="col-md-3">
    ...
    <div className="card-body bg-dark text-center">
        <button className="btn btn-primary btn-sm w-100" data-toggle="collapse" data-target="#sm2" aria-expanded="false" aria-controls="sm2">Spider-Man Far From Home</button>  
